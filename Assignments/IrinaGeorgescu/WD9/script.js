...
function returnGivenAge(a) {
    let yearsToDays = a * 365;
    return yearsToDays;
}

console.log(returnGivenAge(27));
...
console.log(lessThan100(20, 20));
console.log(lessThan100(20, 90));
...
function animals(chickens, cows, pigs) {
    ...
    let chickenLegs, cowLegs, pigLegs, totalLegs;
